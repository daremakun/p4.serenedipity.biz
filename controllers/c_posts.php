...
class posts_controller extends base_controller {
	...
	// If the user id is set then we query for posts by that user
	...
	// If the user id is not set in querystring then we get all users posts		
	} else {
    ...
    public function following() {
        ...
        # Set up the View
        $this->template->content = View::instance('v_posts_index');
        $this->template->title = "Currently Following";
    ...
    public function add($error = NULL) {
        ...
        $this->template->content->title = "Add Post";
    ...
    public function p_add() {
        ...
        Router::redirect('/posts/index' . '?user_id=' . $this->user->user_id );
	...
	// Let the view know that this is edit mode
	...
	Router::redirect('/posts/index' . '?user_id=' . $this->user->user_id . "&delete=true" );
